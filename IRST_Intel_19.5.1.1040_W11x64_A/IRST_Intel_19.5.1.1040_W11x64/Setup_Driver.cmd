@echo off
REM Create by MVP v2.0.8.7
title Installing Intel Intel Rapid Storage Technology iRST
...
if exist C:\OEM\Preload\Command\POP*.ini ECHO [Intel Intel Rapid Storage Technology iRST]>> C:\OEM\Preload\OEMINFLIST.ini
